        ...
        <div className="bg-base-300 rounded-xl p-6 space-y-8">
          ...
          <div className="space-y-6">
            <div className="space-y-1.5">
              ...
              <p className="px-4 py-2.5 bg-base-200 rounded-lg border text-white">{authUser?.fullName}</p>
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <p className="px-4 py-2.5 bg-base-200 rounded-lg border text-white">{authUser?.email}</p>
            </div>
          </div>
